...
export const createNewUser = formUser => dispatch => {
    ...
    .then(user => dispatch(receiveCurrentUser(user)), err => dispatch(receiveErrorsSignUp(err.responseJSON)))};
    

export const login = formUser => dispatch => postSession(formUser)
    .then(user => dispatch(receiveCurrentUser(user)), err => dispatch(receiveErrorsLogIn(err.responseJSON)));
