...
class EditPinShow extends React.Component {
  ...
  componentDidMount() {
    this.props.fetchPin(window.editPin).then((data) => {
  ...
  deletePinFunction(e) {
    this.props
      .deletePin(Number(window.editPin))
      .then(
  ...
  render() {
    ...
    const stateBoard = boards.filter(
      (board) => board.id === Number(this.state.pin.board_id)
    );
    ...
    return (
      <div className="outer-div-edit-pin-modalthing">
          ...
          <div className="left-section-edit-p">
            ...
            <div className="title-edit-pin all-left-section-edit-p">
              ...
              <input
                type="text"
                autoComplete="off"
                className="edit-pin-input input-section-edit-pin-123"
                value={
                  this.state.pin.title === null ? "" : this.state.pin.title
                }
                onChange={this.handelChange("title")}
              />
            </div>

            <div className="description-section-edit-p all-left-section-edit-p">
              <div className="description-word-edit-p the-edit-labels">
                Description
              </div>
              <textarea
                className="description-input-edit-p input-section-edit-pin-123"
            ...
            <div className="url-link-edit-p all-left-section-edit-p">
              <div className="url-website-edit-p-word the-edit-labels">
                Website
              </div>
              <input
                type="text"
                autoComplete="off"
                className="edit-pin-input input-section-edit-pin-123"
                value={this.state.pin.websiteURL}
                onChange={this.handelChange("websiteURL")}
              />
            </div>

            <div className="alt-txt-edit-p all-left-section-edit-p">
              <div className="alt-txt-word-edit-p the-edit-labels">
                Alt Text
              </div>
              <div className="input-section-alt-txt-edit-p">
                <input
                  ...
                  autoComplete="off"
                  className="edit-pin-input input-section-edit-pin-123"
                  value={this.state.pin.description2}
                  onChange={this.handelChange("description2")}
                />
                <div className="alt-txt-underinput-edit-p">
                  This helps people using screen readers understand what your
                  Pin is about.
                </div>
              </div>
            </div>
        ...
        <div className="bottom-section-edit-pin">
          <div
            className="footer-edit-pin-gray-button"
            onClick={this.deletePinFunction}
          >
            Delete
          </div>
          ...
          <div className="right-side-footer-edit-p">
            ...
            <div className="save-btn-edit-pin" onClick={this.handeSave}>
              Save
            </div>
          </div>
        </div>
