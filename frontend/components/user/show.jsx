...
class UserShow extends React.Component {
  ...
  componentDidMount() {
    ...
    this.props.fetchUserProfile(this.props.match.params.id).then((data) => {
      let prevState = this.state.userProfiles;
  ...
  componentDidUpdate(prevProps) {
    if (prevProps.boards !== this.props.boards) {
      ...
      this.setState({
        following: this.props.follow.amFollowing,
        followers_count: this.props.follow.followers.count,
        following_count: this.props.follow.following.count,
      });
      ...
      if (
        Number(this.props.currentUser.id) === Number(this.props.match.params.id)
      ) {
        this.setState({ currentUserProfile: true });
      }
      this.props.fetchUserFollowing(followData);
  ...
  render() {
    ...
    if (this.state.userProfile.id === this.props.currentUser.id) {
      profilePage = (
        ...
        <div>
          <div className="show-page-box-1">
            <header className="profile-header">
              ...
              <h2 className="username-on-profile">
              ...
              <h1 className="email-on-profile follow-following-show">
                {" "}
                {this.state.followers_count} followers •{" "}
                {this.state.following_count} following
              </h1>
            </header>
          </div>
          ...
          <div className="boards-grid-area">
            {boards.map((board) => (
              <div className="dont-show-me" key={board.id}>
                <div
                  className="logo-on-logged-in-header-board-tile"
                ...
                >
                  <div className="board-display-card">
                    ...
                    >
                      <div
                        className="logo-on-logged-in-header-board-lock"
                        style={
                          board.is_private
                            ? { display: "flex" }
                            : { display: "none" }
                    ...
                    >
                      ...
                      <div className="other-two-images">
                        ...
                        <div className="bottom-box">
                          <div className="smaller-image-show-board-tiles1">
                            {!!board.pinPhotos.three ? (
                              <img
                                className="image-board-1"
                                src={board.pinPhotos.three}
                                alt=""
                              />
                            ) : (
                              <img src="" alt="" />
                    ...
                    <div className="title-pin-section">
                      ...
                      <div className="pins-days">
                        ...
                        <h2 className="days-number">
                          {handelDate(board.updated_at)} d
                        </h2>
                      </div>
                    </div>
                  </div>
        ...
        <div>
          <div className="show-page-box-1">
            <header className="profile-header">
              ...
              <div
                className="following-btn-22-1"
                id="following-btn-22-1"
              ...
              <div
                className="following-btn-22-2"
                id="following-btn-22-2"
