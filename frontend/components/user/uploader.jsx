...
class Uploader extends React.Component {
  ...
  handelSubmit(theStateStuff) {
    ...
    this.props.updateUser(formData, this.props.fetchUser).then(() => {
  ...
  render() {
    return (
      <div className="the-outer-box-modal-editModal">
        ...
        {this.state.loading ? (
          <div className="outside-div-loading-on-profile-edit">
            {" "}
            <LoadingIcon />{" "}
          </div>
        ) : (
          <div className="form-uploader-pic">
            <div className="input-box-modal-file-div">
              <label
                htmlFor="input-image-profile-pic-uploader"
                id="label-profile-pic-upload"
              >
                <div className="button-profile-script">Choose photo</div>
                <input
                  type="file"
                  autoComplete="off"
                  name="input-image-profile-pic-uploader"
                  id="input-image-profile-pic-uploader"
