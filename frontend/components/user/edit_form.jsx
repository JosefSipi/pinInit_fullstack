...
class EditForm extends React.Component {
  ...
  saveChanges(e) {
    ...
    this.props.updateUserInfo(submitData).then((data) => {
      data;
  ...
  componentDidMount() {
    this.props.fetchUser(this.props.currentUser.id).then((data) => {
      let firstEditUser = {};
          ...
          <div>
            <div className="main-edit-form">
              ...
              <div className="edit-profile-box1">
                ...
                <h3 className="sub-text-edit-profile">
              ...
              <div className="profile-pic-edit">
                <div className="profile-div-edi-form mod-on-div-edit-profile">
                  ...
                  {!(this.props.currentUser.photoUrl === "false") ? (
                    <img
                    ...
                    <p className="profile-letter">
                      {this.props.currentUser.f_name[0].toUpperCase()}
                    </p>
                  )}
                </div>

                <button
                  className="signup-btn edit-board-btn"
                  onClick={() => this.props.openModal("uploadPhoto")}
                >
                  Change
                </button>
              </div>
              ...
              <div className="edit-input-edit-user">
                ...
                <input
                  ...
                  value={
                    !!this.state.editUser.bio ? this.state.editUser.bio : ""
                  }
                  readOnly
                />
              </div>
