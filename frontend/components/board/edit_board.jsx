    ...
    return (
      <div className="div-prim-edit-board">
        ...
        <div className="middle-section-edit-from-board">
          <form
            className="editng-board-from-board"
            id="the-button-edinging-board-onboard"
          ...
          >
            ...
            <label
              className="check-box-label-edingboard"
              htmlFor="private-checkbox"
            >
              <input
                className="the-check-box-edingingboardonboard"
                checked={this.state.board.is_private === true ? true : false}
                type="checkbox"
                name="example name"
                id="private-checkbox"
                value={!this.state.board.is_private}
                onChange={this.handelChange("is_private")}
              />
              <p className="theediningkeep-board">Keep this board secret</p>
            </label>
            <div className="div-word-1">
        ...
        <div className="bottom-div-edit-board-on-board">
          <div className="save-btn-edit-pin" onClick={this.handelSubmit}>
            Done
          </div>
        </div>
      </div>
