...
class LogIn extends React.Component {
  ...
  handelDemo(e) {
    ...
    this.props
      .login({ email: "demoUser@email.com", password: "123456" })
      .then(() => {
        this.props.history.push("/feed");
  ...
  render() {
    ...
    if (!!this.props.errors) {
      if (
        ...
        this.props.errors[0] === "The password you entered is incorrect." &&
      ...
      <div className="the-outer-box-modal">
        ...
        <div className="session-form">
          ...
          <form className="main-login-form" onSubmit={this.handelSubmit}>
            ...
            <input
              className="top-margin-login-button"
              type="submit"
              value="Log in"
            />
          ...
          <h3 className="dark-text">Terms of Service, Privacy policy.</h3>
